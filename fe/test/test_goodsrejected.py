...
class TestCancel:
    ...
    def pre_run_initialization(self):
        ...
        self.seller_id = "test_goodsrejected_seller_id_{}".format(str(uuid.uuid1()))
        self.store_id = "test_goodsrejected_store_id_{}".format(str(uuid.uuid1()))
        ...
        assert code == 200
        code = self.gen_book.seller.ship_order(self.seller_id,self.store_id,self.order_id)
        assert code == 200
    ...
    def test_ok(self):
        code = self.buyer.goodsrejected(self.order_id)
        assert code == 200
